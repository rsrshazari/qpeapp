...
<style type="text/css">
  ...
  {
    border: 1px dashed #ffe600 !important;
    cursor: pointer;
  }
  ...
  .multi_layout .list-group .list-group-item.active{border:.5px solid #ffe600;}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo $this->lang->line("Create Store"); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>This feature is available to our Pro+ and Enterprise subscribers. To upgrade your plan, contact us at <a href="mailto:sale@qpe.co.in">sale@qpe.co.in</a></p>
      </div>
    </div>
  </div>
</div>
...
<section class="section">
  <div class="section-header m-0">
    ...
    <?php
           ...
           $query=$this->db->query("select COUNT(*) AS total_store from ecommerce_store where user_id=$user_id")->result();
           if($query[0]->total_store < 1 && $user_type=='Member'){
      ?>
    ...
    { 
      ...
      <div class="row multi_layout">
        ...
        (
          ...
          (
            'class'=>'',
            'href'=>base_url('ecommerce/store_list'),
          ...
          (
            'class'=>'',
            'href'=>base_url("ecommerce/store/".$current_store_data['slug']),
