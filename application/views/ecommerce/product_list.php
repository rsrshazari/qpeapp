  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo $this->lang->line("Product"); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>You can't upload more then 100 product. If you want to upload more please contact us at <a href="mailto:sale@qpe.co.in">sale@qpe.co.in</a></p>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="card no_shadow">
          <div class="card-body data-card p-0 pt-1 pr-3">
            <div class="row">
              ...
              $query=$this->db->query("SELECT COUNT(*) AS total_product FROM ecommerce_product WHERE store_id=$store_id AND user_id=$user_id")->result(); 
             
              if($query[0]->total_product <=100 && $user_type=='Member'){
              ?>    
