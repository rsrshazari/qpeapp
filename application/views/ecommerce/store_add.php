							...
							<div class="row">
							  ...
							  <div class="form-group col-12 col-md-6">
							   ...
							   <div class="form-group col-12 col-md-6">
							    ...
							    <input type="text" isfield="false" name="store_name" id="store_name" class="form-control" onkeyup=fncheck_store();>                      
							    ...
							    <div class="form-group">
							      ...
							      <div id="store-logo-dropzone" class="dropzone mb-1">
							        <div class="dz-default dz-message">
							          ...
							          <span style="font-size: 20px;"><i class="fas fa-cloud-upload-alt" title='<?php echo $this->lang->line("Upload"); ?>' data-toggle="tooltip" style="font-size: 35px;color: #ffe600;"></i> </span>
							        </div>
							      </div>
							      <span class="red"></span>
							    </div>
	...
	$("document").ready(function()	{
		...
		$(document).on('change','#page',function(event){
			...
			var page_id=$(this).val();			 
			  $.ajax({
			  type:'POST' ,
			  url: base_url+"ecommerce/check_store_name",
  ...
  var store_name=$("#store_name").val();
			  ...
			  success:function(response){
  			 if(response=='Already taken'){
   			 $("#store_name").attr("isfield", "true"); 
			 $("#status_msg").html(response).css({"color": "red", "font-size": "150%"});
 			}else{
  		    $("#status_msg").html(response).css({"color": "green", "font-size": "150%"});
   		    $("#store_name").attr("isfield", "false")
  		    }
		}
	});
  }
