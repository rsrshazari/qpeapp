      ...
      <div class="col-12">
          ...
          <div class="card no_shadow">
            <div class="card-body p-0">
                ...
                <div class="card">
                  ...
                  <div class="card-footer p-3" style="border:1px solid #e4e6fc">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo $this->lang->line("UPI Id");?></label>
                          <input name="upi_id" value="<?php echo isset($xvalue['upi_id']) ? $xvalue['upi_id'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('upi_id'); ?></span>
                        </div>
                      </div>

                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo $this->lang->line("UPI User name");?></label>
                          <input name="upi_user_name" value="<?php echo isset($xvalue['upi_user_name']) ? $xvalue['upi_user_name'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('upi_user_name'); ?></span>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                       ...
                       <div class="col-12 col-md-3">
                        ...
                        <div class="col-12 col-md-3">
                          ...
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("UPI checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="upi_enabled" value="1" class="selectgroup-input" <?php if($xdata2["upi_enabled"]=='1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes") ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="upi_enabled" value="0" class="selectgroup-input" <?php if($xdata2["upi_enabled"]=='0') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("No") ?></span>
                              </label>
                            </div>
                          </div>
                ...
                <div class="card">
                    <div class="card-header p-3"  style="border:1px solid #e4e6fc;border-bottom: none;">
                      <h4><?php echo $this->lang->line("shipping"); ?></h4><hr>
                    </div>
                    <div class="card-footer p-3" style="border:1px solid #e4e6fc;">
                      <div class="row">
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo $this->lang->line("Dunzo API Key");?></label>
                          <input name="dunzo_secret_key" value="<?php echo isset($xvalue['dunzo_secret_key']) ? $xvalue['dunzo_secret_key'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('dunzo_secret_key'); ?></span>
                        </div>
                      </div>
                      <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo $this->lang->line("Dunzo User Name");?></label>
                          <input name="dunzo_client_id" value="<?php echo isset($xvalue['dunzo_client_id']) ? $xvalue['dunzo_client_id'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('dunzo_client_id'); ?></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo $this->lang->line("borzo secret Key");?></label>
                          <input name="borzo_secret_key" value="<?php echo isset($xvalue['borzo_secret_key']) ? $xvalue['borzo_secret_key'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('borzo_secret_key'); ?></span>
                        </div>
                      </div>                    
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo $this->lang->line("borzo authentication Key");?></label>
                          <input name="borzo_authentication_Key" value="<?php echo isset($xvalue['borzo_authentication_Key']) ? $xvalue['borzo_authentication_Key'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('borzo_authentication_Key'); ?></span>
                        </div>
                      </div>
                      </div>
                    <div class="row">
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo $this->lang->line("rapido API Key");?></label>
                          <input name="rapido_secret_key" value="<?php echo isset($xvalue['rapido_secret_key']) ? $xvalue['rapido_secret_key'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('rapido_secret_key'); ?></span>
                        </div>
                      </div>                    
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo $this->lang->line("rapido user name");?></label>
                          <input name="rapido_user_name" value="<?php echo isset($xvalue['rapido_user_name']) ? $xvalue['rapido_user_name'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('rapido_user_name'); ?></span>
                        </div>
                      </div>
                      </div>
                    ...
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""><?php echo $this->lang->line("Shiprocket API Key");?></label>
                          <input name="shiprocket_api_key" value="<?php echo isset($xvalue['shiprocket_api_key']) ? $xvalue['shiprocket_api_key'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('shiprocket_api_key'); ?></span>
                        </div>
                      </div>                    
                    <div class="col-6 col-md-6">
                        <div class="form-group">
                          <label for=""> <?php echo $this->lang->line("Shiprocket User Name");?></label>
                          <input name="shiprocket_user_name" value="<?php echo isset($xvalue['shiprocket_user_name']) ? $xvalue['shiprocket_user_name'] :""; ?>" class="form-control" type="text">  
                          <span class="red"><?php echo form_error('shiprocket_user_name'); ?></span>
                        </div>
                      </div>
                      </div>
                       <div class="row">
                      <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("Dunzo Checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="dunzo_enabled" value="1" class="selectgroup-input" <?php if(@$xdata2["dunzo_enabled"]=='1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes") ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="dunzo_enabled" value="0" class="selectgroup-input" <?php if(@$xdata2["dunzo_enabled"]=='0') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("No") ?></span>
                              </label>
                            </div>
                          </div>
                       ...
                       <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("Borzo Checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="borzo_enabled" value="1" class="selectgroup-input" <?php if(@$xdata2["borzo_enabled"]=='1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes"); ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="borzo_enabled" value="0" class="selectgroup-input" <?php if(@$xdata2["borzo_enabled"]=='0') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("No") ?></span>
                              </label>
                            </div>
                          </div>
                       ...
                       <div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("Rapido Checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="rapido_enabled" value="1" class="selectgroup-input" <?php if(@$xdata2["rapido_enabled"]=='1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes") ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="rapido_enabled" value="0" class="selectgroup-input" <?php if(@$xdata2["rapido_enabled"]=='0') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("No") ?></span>
                              </label>
                            </div>
                          </div>
...
<div class="col-12 col-md-3">
                          <div class="form-group">
                            <label>
                              <?php echo $this->lang->line("Shiprocket Checkout"); ?> *
                            </label>
                            <div class="selectgroup w-100">
                              <label class="selectgroup-item">
                                <input type="radio" name="shiprocket_enabled" value="1" class="selectgroup-input" <?php if(@$xdata2["shiprocket_enabled"]=='1') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("Yes") ?></span>
                              </label>
                              <label class="selectgroup-item">
                                <input type="radio" name="shiprocket_enabled" value="0" class="selectgroup-input" <?php if(@$xdata2["shiprocket_enabled"]=='0') echo 'checked'; ?>>
                                <span class="selectgroup-button"> <?php echo $this->lang->line("No") ?></span>
                              </label>
                            </div>
                          </div>
