    ...
    var is_mobile =  '<?php echo $this->session->userdata("is_mobile");?>';
      ...
      if(
            is_mobile=='0' && ( 
              ...
              (controller_name=="instagram_poster" && (function_name=="image_video_edit_auto_post" || function_name=="image_video_poster")) || 
              (controller_name='message_manager' && (function_name=="message_dashboard" || function_name=="instagram_message_dashboard"))
            )
        )
