<li class="dropdown" id="xxx"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
  ...
  <div class="dropdown-menu dropdown-menu-right">
    ...
    <?php $current_account = isset($fb_rx_account_switching_info[$this->session->userdata("facebook_rx_fb_user_info")]) ? $fb_rx_account_switching_info[$this->session->userdata("facebook_rx_fb_user_info")] : $this->lang->line("No Account"); ?>
    ...
    <div class="collapse" id="collapseExampleFBA">
      ...
      foreach ($fb_rx_account_switching_info as $key => $value) 
      {
        ...
        echo '<a href="" data-id="'.$key.'" class="dropdown-item account_switch '.$selected.'"><i class="fas fa-toggle-on"></i> '.$value.'</a>';
      } 
      ?>
    </div>
