...
@media (min-width: 992px) {
    ...
    .no_padding_col_left{padding-left: 0 !important;}
    .no_padding_col_right{padding-right: 0 !important;}
    .main_row{margin-left: 0;}
  }
}
.card.chat-box{border-radius: 0;}
.search_list{width: 130px;}
#refresh_interval{width: 95px;height: 30px;padding-right: 0}
...
max-width: 100%;
margin-bottom: 10px; }
.makeScroll{max-height: 430px;overflow:auto;}
