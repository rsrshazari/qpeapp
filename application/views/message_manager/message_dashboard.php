<section class="section">
  <div class="section-header">
    <h1><i class="fab fa-facebook"></i> <?php  echo $this->lang->line('Live Chat')." : ".$page_name;?> </h1>
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><?php echo $this->lang->line('Facebook Live Chat'); ?></div>
    </div>
  </div>
        ...
        <div class="card chat-box card-success" style="min-height: 500px" id="mychatbox2">
           ...
           <div class="card-footer chat-form">
              <form id="chat-form2">
                ...
                <div class="row">
                  <div class="col-12 col-md-3 no_padding_col_right">
                  ...
                  <div class="col-12 col-md-9 no_padding_col_left">
