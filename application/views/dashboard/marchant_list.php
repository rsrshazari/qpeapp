                            ...
                            <table class="table table-bordered" id="mytable">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line("Email ID"); ?></th>
                                        ...
                                        <th><?php echo $this->lang->line("Total Product"); ?></th>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var table = $("#mytable").DataTable({
            ...
            pageLength: 10,
            ajax: {
                url: base_url + 'dashboard/marchant_list_data',
                type: 'POST'
            },
            language:
                    {
        ...
        $(document).on('click', '#save_row', function (event) {
            ...
            $.ajax({
                url: base_url + 'dashboard/ajax_create_new_category',
                type: 'POST',
                dataType: 'JSON',
                data: alldatas,
                cache: false,
        ...
        $(document).on('click', '.edit_row', function (event) {
            ...
            $.ajax({
                url: base_url + 'dashboard/ajax_get_category_update_info',
                type: 'POST',
        ...
        $(document).on('click', '#update_row', function (event) {
            ...
            $.ajax({
                url: base_url + 'dashboard/ajax_update_category',
                type: 'POST',
                dataType: 'JSON',
                data: alldatas,
                cache: false,
                    ...
                    .then((willDelete) => {
                        if (willDelete)
                        {
                            ...
                            $.ajax({
                                ...
                                type: 'POST',
                                dataType: 'JSON',
                                url: "<?php echo base_url('dashboard/delete_category') ?>",
                                data: {table_id: table_id},
                                success: function (response)
                                {
                                    if (response.status == '1')
