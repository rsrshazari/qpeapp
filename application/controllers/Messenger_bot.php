...
class Messenger_bot extends Home
{
    ...
    public function create_subscriber($sender_id='', $page_id='',$social_media_type="fb")
    {
        ...
        $select=array("id","unavailable_conversation","unavailable","subscribe_id","first_name","last_name","full_name","status","page_table_id","is_bot_subscriber","user_id","gender","contact_group_id","email","phone_number","birthdate","last_subscriber_interaction_time",'social_media');
    ...
    public function get_user_input_flow_next_question($flow_campaign_id,$latest_question_id=0,$page_id=0,$subscriber_info=array(),$answer="",$fb_message_id="",$message_type=""){
       ...
       $join = array('user_input_flow_campaign'=>"user_input_flow_campaign.id=user_input_flow_questions.flow_campaign_id,right");
        ...
        if($latest_question_id!=0 && $invalid_answer==false){
            ...
            // Assaign Labels 
            $this->multiple_assign_label($sender_id,$page_id,$label_ids,$social_media_type);
    ...
    public function webhook_callback_main()
    {
        ...
        // $response_raw='{"object":"page","entry":[{"id":"971601563041379","time":1637478122210,"messaging":[{"sender":{"id":"2216469075131584"},"recipient":{"id":"971601563041379"},"timestamp":1637478121950,"message":{"mid":"m_KGfbcWmlhQd9zUmthMpK-FoTjdE6TYfT3_F8FWBEv6hMKtXWNdQrA6RKZemMl81CJPHJbZZbU2HL1aT2sXSiBw","text":"new horizon"}}]}]}';
    ...
    {   
        ...
        $this->instagram_bot_addon_exist = addon_exist($module_id=320,$addon_unique_name="instagram_bot");
        ...
        if($media_type == 'ig')
            $data['page_title'] = $this->lang->line('Instagram Bot Settings');  
    ...
    public function get_page_details()
    {
        ...
        else
        {
            if($gid!='' && $getstarted_info[0]['visual_flow_type']=='general') 
                ...
                $gurl = base_url("visual_flow_builder/edit_builder_data/").$getstarted_info[0]['visual_flow_campaign_id']."/0";
        }
            ...
            if(!empty($nomatch_info))
            {
                ...
                else
                {
                    if($nid!='' && (isset($nomatch_info[0]['visual_flow_type']) && $nomatch_info[0]['visual_flow_type']=='general')) 
                        ...
                        $nurl = base_url("visual_flow_builder/edit_builder_data/").$nomatch_info[0]['visual_flow_campaign_id']."/0/".$media_type;
                }
            }
            else
               $nurl = base_url("messenger_bot/edit_bot/").$nid."/1/nomatch/".$media_type; 
        ...
        else
        {
            ...
            else
            {
                if($nid!='' && $nomatch_info[0]['visual_flow_type']=='general') 
                    ...
                    $nurl = base_url("visual_flow_builder/edit_builder_data/").$nomatch_info[0]['visual_flow_campaign_id']."/0";
            }
        }
        ...
        foreach($action_button_info as $key => $value) 
        {
            ...
            {
                if($value['template_for']=='unsubscribe') $uurl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";
                else if($value['template_for']=='resubscribe') $rurl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";
                else if($value['template_for']=='email-quick-reply') $eurl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";         
                else if($value['template_for']=='phone-quick-reply') $purl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";         
                else if($value['template_for']=='location-quick-reply') $lurl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";         
                else if($value['template_for']=='birthday-quick-reply') $jurl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";         
                else if($value['template_for']=='chat-with-human') $hurl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";        
                else if($value['template_for']=='chat-with-bot') $burl=base_url("visual_flow_builder/edit_builder_data/").$value['visual_flow_campaign_id']."/0";
            }
            else
            {
        ...
        if($media_type == "fb" || $media_type == "") {
            $middle_column_content .='<div class="dropdown avatar-badge">
                          ...
                          <div class="dropdown-menu large">';
                            if(stripos($gurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$gurl.'"><i class="fas fa-check-circle"></i> '.$this->lang->line("Get-started Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$gurl.'"><i class="fas fa-check-circle"></i> '.$this->lang->line("Get-started Template").'</a>';

                            if(stripos($nurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$nurl.'"><i class="fas fa-comment-slash"></i> '.$this->lang->line("No Match Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$nurl.'"><i class="fas fa-comment-slash"></i> '.$this->lang->line("No Match Template").'</a>';

                            if(stripos($uurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$uurl.'"><i class="fas fa-user-slash"></i> '.$this->lang->line("Un-subscribe Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$uurl.'"><i class="fas fa-user-slash"></i> '.$this->lang->line("Un-subscribe Template").'</a>';

                            if(stripos($rurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$rurl.'"><i class="fas fa-user-circle"></i> '.$this->lang->line("Re-subscribe Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$rurl.'"><i class="fas fa-user-circle"></i> '.$this->lang->line("Re-subscribe Template").'</a>';

                            if(stripos($eurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$eurl.'"><i class="fas fa-envelope"></i> '.$this->lang->line("Email Quick Reply Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$eurl.'"><i class="fas fa-envelope"></i> '.$this->lang->line("Email Quick Reply Template").'</a>';

                            if(stripos($purl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$purl.'"><i class="fas fa-phone"></i> '.$this->lang->line("Phone Quick Reply Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$purl.'"><i class="fas fa-phone"></i> '.$this->lang->line("Phone Quick Reply Template").'</a>';

                            if(stripos($lurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$lurl.'"><i class="fas fa-map"></i> '.$this->lang->line("Location Quick Reply Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$lurl.'"><i class="fas fa-map"></i> '.$this->lang->line("Location Quick Reply Template").'</a>';

                            if(stripos($jurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$jurl.'"><i class="fas fa-birthday-cake"></i> '.$this->lang->line("Birthday Quick Reply Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$jurl.'"><i class="fas fa-birthday-cake"></i> '.$this->lang->line("Birthday Quick Reply Template").'</a>';

                            if(stripos($hurl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$hurl.'"><i class="fas fa-headset"></i> '.$this->lang->line("Chat with Human Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$hurl.'"><i class="fas fa-headset"></i> '.$this->lang->line("Chat with Human Template").'</a>';

                            if(stripos($burl,"visual_flow_builder/edit_builder_data"))
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$burl.'"><i class="fas fa-robot"></i> '.$this->lang->line("Chat with Robot Template").'</a>';
                            else
                              $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$burl.'"><i class="fas fa-robot"></i> '.$this->lang->line("Chat with Robot Template").'</a>';
        }
            ...
            $middle_column_content .= '<div class="dropdown avatar-badge">
                  ...
                  <div class="dropdown-menu large">';
                    ...
                    if(stripos($story_mention_url,"visual_flow_builder/edit_builder_data"))
                      $middle_column_content .= '<a class="pointer dropdown-item has-icon" data-height="795" target="_BLANK" href="'.$story_mention_url.'"><i class="fas fa-user-tag"></i> '.$this->lang->line("Story Mention Template").'</a>';
                    else
                      $middle_column_content .= '<a class="pointer dropdown-item has-icon iframed" data-height="795" href="'.$story_mention_url.'"><i class="fas fa-user-tag"></i> '.$this->lang->line("Story Mention Template").'</a>';
        }
    ...
    public function template_manager($media_type="fb")
    {
        $media_type = $media_type;
    ...
    public function template_manager_data()
    {
        ...
        if($this->addon_exist("visual_flow_builder"))
            $display_columns = array("#","CHECKBOX",'id', 'page_name', 'bot_name', 'postback_id', 'visual_flow_type', 'action');
        else
        ...
        $where_simple['messenger_bot_postback.media_type'] = "fb";
        if($page_id != '') $where_simple['messenger_bot_postback.page_id'] = $page_id;
        if($template_media_type == 'ig') 
            $where_simple['messenger_bot_postback.media_type'] = $template_media_type;
        ...
        foreach ($info as $key => $value) 
        {
            ...
            {
                $action .= "<a class='btn btn-circle btn-outline-warning edit_reply_info' title='". $this->lang->line("Edit") ."' href='#' table_id='".$value['visual_flow_campaign_id']."' media_type='".$value['media_type']."' ><i class='fas fa-edit'></i></a>&nbsp;";
                $info[$i]["visual_flow_type"] = $this->lang->line('Flow Builder');
            }
            else
            {
                $temp = base_url("messenger_bot/edit_template/{$value["id"]}/0/0/{$value["media_type"]}");
            ...
            $temp = base_url("messenger_bot/clone_template/{$value["id"]}/0/0/{$value["media_type"]}");
            $action .= "<a class='btn btn-circle btn-outline-primary' title='". $this->lang->line("Clone") ."' href='".$temp."'><i class='far fa-copy'></i></a>&nbsp;<a href='#' class='btn btn-circle btn-outline-danger delete_template' title='".$this->lang->line("Delete")."' table_id='".$value['id']."'><i class='fa fa-trash'></i></a></div>";
    ...
    public function import_bot()
    {
        ...
        if($this->db->table_exists('user_input_flow_campaign')) {
            ...
            $delete_query="DELETE user_input_flow_campaign,user_input_flow_questions from user_input_flow_campaign left JOIN user_input_flow_questions on user_input_flow_campaign.id=user_input_flow_questions.flow_campaign_id where user_input_flow_campaign.user_id={$this->user_id} and page_table_id={$page_id}";
        ...
        if($this->db->table_exists('visual_flow_builder_campaign')) {
            ...
            $this->basic->delete_data("visual_flow_builder_campaign",array("user_id"=>$this->user_id,"page_id"=>$page_id));
        ...
        // Inserting Sequence Campaign Information
         ...
         if($this->db->table_exists('messenger_bot_drip_campaign')) {
            ...
            $this->basic->delete_data("messenger_bot_drip_campaign",array("page_id"=>$page_id,"user_id"=>$this->user_id));
        ...
        $this->session->set_userdata("bot_list_get_page_details_page_table_id",$page_id); 
    ...
    private function get_bot_settings($page_table_id=0)
    {
        ...
        if($this->db->table_exists('user_input_flow_campaign')) {
            ...
            $input_flow_info=$this->get_user_input_flow_settings_info($this->user_id,$page_table_id);
        ...
        if($this->db->table_exists('visual_flow_builder_campaign')) {
            $full_bot_settings['flow_builder_campaign_information']= $this->get_flow_builder_settings_info($this->user_id,$page_table_id);
        }

        if($this->db->table_exists('messenger_bot_drip_campaign')) {
            $full_bot_settings['sequence_campaign_information']= $this->get_sequence_campaign_info($this->user_id,$page_table_id);
        }
        return $full_bot_settings;
    }


    public function get_flow_builder_settings_info($user_id,$page_table_id){

        $flow_builder_campaign_where['where']=array("user_id"=>$user_id,"page_id"=>$page_table_id);
    ...
    public function get_sequence_campaign_info($user_id,$page_table_id){

    	$sequence_campaign_where['where']=array("user_id"=>$user_id,"page_id"=>$page_table_id,"campaign_type"=>"messenger","drip_type"=>"custom");
    ...
    public function get_user_input_flow_settings_info($user_id,$page_table_id){

        // get custom fields data. Custom fields data is user based not page based. So collecting it as where user_id 
        $custom_field_where['where']=array("user_id"=>$user_id);
        ...
        $user_input_flow_where['where']=array("page_table_id"=>$page_table_id,"deleted"=>"0");
...
'.json_encode($json_value).'
        ...
        */
        ...
        public function saved_templates()
        {
            ...
            // echo "<pre>"; print_r(count($templates)); exit;

            /* set cinfiguration for pagination */
            $config = array(
                'uri_segment' => 3,
                'base_url' => base_url('messenger_bot/saved_templates/'),
