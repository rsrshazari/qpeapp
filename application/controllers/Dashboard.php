...
$web=0;$app=0;
    ...
    public function all_store() {
        ...
        $data['store'] = $this->basic->get_data("ecommerce_store",  'ecommerce_store.*,page_name,page_profile,facebook_rx_fb_page_info.page_id as fb_page_id', array('facebook_rx_fb_page_info' => "facebook_rx_fb_page_info.id=ecommerce_store.page_id,left"), '', $start = NULL, $order_by = "store_name ASC");
...
//        $this->excel->getActiveSheet()->getStyle('A1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    public function marchant_list_data() {
        $search_value = $_POST['search']['value'];
        $display_columns = array("#", 'CHECKBOX', 'serial', 'name', 'email', 'mobile', 'source', 'package_name', 'store_name', 'status', 'total_product', 'add_date',);
