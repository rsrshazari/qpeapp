...
class Toyyibpay{
	...
	function __construct(){
		...
		if($this->toyyibpay_mode=='sandbox') {
			...
			$this->getBillTransactions = "https://dev.toyyibpay.com/index.php/api/getBillTransactions";
		}
		else{

			 $this->toyyibpay_api_url="https://toyyibpay.com/";
			 $this->toyyibpay_bill_url="https://toyyibpay.com/index.php/api/createBill";
			 $this->getBillTransactions = "https://toyyibpay.com/index.php/api/getBillTransactions";
		}
	}
